...
import { ArrowLeft, Heart, MessageSquare, Info, Sparkles, Bot, Layers, Search, Archive, ImageIcon, X, ChevronDown, FileText, Maximize2, ZoomIn, ZoomOut, RotateCcw } from 'lucide-react';
...
function ImageFullscreen({ item, onClose }: { item: SearchResultItem; onClose: () => void }) {
